...
uint256 hashGenesisBlock("0x3e0afef57cd42d3ccef4d9d66fe809fbd20a3f5fdb39fc32ce74caeae438d2ae");
...
const string strMessageMagic = "Equalicoin Signed Message:\n";
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // Equalicoin: 7 days
static const int64 nTargetSpacing = 420; // Equalicoin: 7 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal equalicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Equalicoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3e0afef57cd42d3ccef4d9d66fe809fbd20a3f5fdb39fc32ce74caeae438d2ae");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is me, talking to my favorite girl in the world, Jess Kane.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1403172911; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   =3121310;

        if (fTestNet)
        {
            block.nTime    =  1403172911;
            block.nNonce   = 91252;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xce271f165659f1d598648fe9da60164b481aa6e92c4ef1b93b17ebf8477d0951"));
